...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiZ2hvc3RzaW50b3dlcnMiLCJhIjoiY2tibW81Z21sMWtvZjJ4bWx4dDc0NDZ1NiJ9.W5NWupbj4q0WTXqivmze6w';
...
var stripe = Stripe('pk_test_51Gza0KIxnngy6x5C89rZ37kzZJtewUSCrVvd7JPxmYXLo9rYlq4C9mi0sNZL3lrglFNX14S59nv7AUXrDpVnkCmK00YZ3UEg1H');
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            console.log(tourId);
            console.log(session); // Create checkout form + charge CC
...
if (bookBtn) bookBtn.addEventListener('click', function (e) {
  e.target.textContent = 'Booking Now...';
